...
class TaskDoneTile extends StatefulWidget {
  TaskDoneTile({Key? key,required this.mylist}) : super(key: key);
  final  List mylist;
  @override
  _TaskTileState createState() => _TaskTileState();
}
class _TaskTileState extends State<TaskDoneTile> {
    ...
    return  ConditionalBuilder(
      ...
      builder: (context) => ListView.builder(
        ...
        itemBuilder: (context, index) {
          if(doneTasks[index]['repeat']=='Daily'){
            DateTime date = DateFormat.jm().parse(doneTasks[index]['starttime'].toString());
                ...
                child: FadeInAnimation(
                  child: Row(
                    children: [
                      GestureDetector(
                        onTap: (){
                          _showBottomSheet(context,doneTasks[index]);
                        },
          ...
          if(doneTasks[index]['date']==DateFormat.yMd().format(AppCubit.get(context).selectedDate)){
            return AnimationConfiguration.staggeredList(
              position: index,
              child: SlideAnimation(
                child: FadeInAnimation(
